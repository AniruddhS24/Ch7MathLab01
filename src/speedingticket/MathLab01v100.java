...
class Geometry
{
	...
	{ 
        ...
        public static double parallelogramArea (double bs1, double h)             
	{ 
	    return bs1 * h; 
	}
        public static double triangleArea (double bs1, double h)             
	{ 
	    return (bs1*h)/2; 
	}
        public static double trapezoidArea (double bs1, double bs2, double h)             
	{ 
	    return (bs1+bs2)/2*h; 
	}
        public static double hexagonArea (double bs1, double bs2, double h)             
	{ 
	    return (bs1+bs2)*h; 
	}
